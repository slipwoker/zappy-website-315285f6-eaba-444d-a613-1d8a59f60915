document.addEventListener('DOMContentLoaded', function () {
  ...
  // Auto-detect and animate common section elements if no explicit classes found
  if (animatableElements.length === 0) {
    const autoSelectors = [
      'section > .container',
      '.card',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עולם הסקווישים של מאיה וליה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '315285f6-eaba-444d-a613-1d8a59f60915',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '315285f6-eaba-444d-a613-1d8a59f60915';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '315285f6-eaba-444d-a613-1d8a59f60915';
